...
const checkpoints = [
    { lat: 38.890760751698224, lng: -77.09456107931626, radius: 40, audioKey: "checkpoint1" }, // Example coordinates and radius
    { lat: 38.89095162561316, lng: -77.09519500334783, radius: 40, audioKey: "checkpoint2" },
    { lat: 38.89139152494132, lng: -77.09419741012081, radius: 40, audioKey: "checkpoint3" },
    { lat: 38.891828469221075, lng: -77.09312395428827, radius: 40, audioKey: "checkpoint4" },
    { lat: 38.89112581426466, lng: -77.09258153669099, radius: 40, audioKey: "checkpoint5" },
    { lat: 38.890257819137375,  lng: -77.09525647142884, radius: 40, audioKey: "checkpoint6" },
    { lat: 38.89076474397313, lng: -77.09514361335668, radius: 40, audioKey: "checkpoint7" }
];
